...
let transp = ["Honda Motorcycle", "Toyota Car", "F-16 Plane"];
let kix = ("I would like to own a");
console.log(`${kix} ${transp[0]}`);
console.log(`${kix} ${transp[1]}`);
console.log(`${kix} ${transp[2]}`);
